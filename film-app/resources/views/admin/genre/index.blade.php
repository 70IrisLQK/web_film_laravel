                        ...
                        <tbody>
                            @foreach ($listGenres as $key => $genre)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('genre.edit', [$genre->id]) }}" class="active"
                                            ui-toggle-class=""><i class="fa fa-edit text-success text"></i>
                                        </a>
                                        <a href="{{ route('genre.destroy', [$genre->id]) }}" class="active"
                ...
                <footer class="panel-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-5 text-center">
                            <small class="text-muted inline m-t-sm m-b-sm">showing {{ count($listGenres) }} of
                                {{ count($listGenres) }} items</small>
                        </div>
